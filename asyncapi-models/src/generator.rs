...
use crate::parser::{Entity, EntityDef, EnumDef, FieldType, Primitive};
...
fn expand_field_type(field_type: FieldType) -> String {
    match field_type {
        ...
        FieldType::Array(None) => "Vec<serde::Value>".into(),
        ...
        FieldType::Object(None) => "serde::Value".into(),
